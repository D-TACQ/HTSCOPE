...
#define PS_SOE_HLD_VERSION_CHECK	"SOE_HLD_VERSION_CHECK"
#define PS_SOE_HLD_VERSION_REQUIRED	"SOE_HLD_VERSION_REQUIRED"
#define PS_SOE_HLD_VERSION_RECEIVED	"SOE_HLD_VERSION_RECEIVED"
...
protected:
	...
	int P_SOE_HLD_VERSION_CHECK;
	int P_SOE_HLD_VERSION_REQUIRED;
	int P_SOE_HLD_VERSION_RECEIVED;
